        ...
        <div class="container" style="padding-top: 150px;padding-bottom: 50px;">
            <div class="row">
                <div class="container">
                    <div class="col-sm-6">
                        ...
                        budget and time issues which we usually face in our daily lives. We are here
                        to provide a budget controller according to your aspects.<br><br>
                        Budget control is the biggest financial issue in the present world.
                        One should look after their budget control to get rid off from their
                        financial crisis.</p>
                    </div>
                    <div class="col-sm-6">
                        <h3>Why choose us?</h3>
            ...
            <div class="row">
                <div class="container">
                    <div class="col-sm-6">
                        <h3>Contact Us</h3>
                        <h5><b>Email:</b> budget@management.com</h5>
                        <h5><b>Mobile:</b> +91-844844853</h5>                    
                    </div>
                </div>
            </div>
        </div>
